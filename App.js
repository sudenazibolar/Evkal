      ...
      <View style={{ flex: 1, marginHorizontal: 30, justifyContent: 'center', }}>
        <View style={{ alignItems: 'center', }}>
          <View style={{ alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Text style={{ fontSize: 30, color: 'black', fontSize: 30, }}>Sign In</Text>
            <Text style={{ fontSize: 30, color: '#B0B0B0', fontSize: 17, marginTop: 10 }}>Hi! Welcome back, you've been missed</Text>
